<script>
    ...
    export default {
        data() {
            ...
            posts: [
                {
                    id: 1,
                    team_member_creator_username: "Иван Петров",
                    postDate: "10:00",
                    text: "Очень-очень важный пост Ивана Петрова",
                    postCommentCount: 5
                },
                {
                    id: 2,
                    team_member_creator_username: "Петр Иванов",
                    postDate: "10:00",
                    text: "Очень-очень важный пост Петра Иванова",
                    postCommentCount: 7
                },
                {
                    id: 3,
    ...
    methods: {
        ...
        editPost(post) {
            ...
            this.currPostText = post.postContent
        ...
        editPostReload(post) {
            ...
            this.posts.map(currPost => {
                if(currPost.post_id == post.post_id) {
                    currPost.postContent = post.text
                }
                return post
            })
