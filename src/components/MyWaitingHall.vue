...
import { getConfContainerWebsocket, getOwnerWebsocket } from '@/websocket'
...
export default {
    ...
    created() {
        ...
        this.ownerSocket = getOwnerWebsocket()
...
<template>
    ...
    <div class="waiting-hall-container">
        ...
        <div class="conference-details">
            ...
            <button @click="start">Видео</button>
            <!-- <button @click="start">НЕ НАЖИМАТЬ</button> -->
        </div>
    </div>
</template>
