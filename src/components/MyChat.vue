...
import MyReceivedMessageFinal from './MyReceivedMessageFinal.vue';
    ...
    export default {
                ...
                messages: [
                    {
                        ...
                        messageText: "Важное сообщение 1",
                        messageDateFinal: "10:00",
                    },
                    {
                        id: 2,
                        senderName: "Петр Иванов",
                        messageText: "Важное сообщение 2",
                        messageDateFinal: "10:01"
                    },
                    {
                        id: 3,
                        senderName: "Иван Петров",
                        messageText: "Важное сообщение 3",
                        messageDateFinal: "10:00",
                        isReaded: true
                    },
                ],
        ...
        methods: {
            ...
            getUserByEmail() {
                fetch(`http://localhost:8082/api/auth/email`, {
                    method: 'POST',
                    headers: {
    ...
    <div class="chat" v-if="addUser == false">
        <div class="chat-navbar">
            <div class="chat-navbar-left">
                <!-- <img alt="Chat photo"> -->
                <h3 class="chat-name">Переговоры</h3>
        ...
        <div v-for="message in messages" :key="message.id" class="dialog" @mouseover="messageReadListener(message)" @click="editMessage(message)">
            <MyMessageFinal v-if="message.senderName === 'Иван Петров'" :messageTextFinal="message.messageText" :sending-time="message.messageDateFinal"
