...
let allParticipants = []
// let admins = computed(() => {
//     return allParticipants.filter(currUser => currUser.userRole == 'Администратор')
// })
// let notAdmins = computed(() => {
//     return allParticipants.filter(currUser => currUser.userRole == 'MeetingRole.PARTICIPANT')
// })
let admins = ref([])
let notAdmins = ref([])
...
<template>
        ...
        <div class="conference-users">
            <!-- <div class="one-user-or-leading"> -->
                ...
                <div class="user-details">
                    <div class="user-username">Rostislav Orlov</div>
                    <div class="user-email">r1@mail.ru</div>
                </div>
            <!-- </div> -->
        ...
        <div class="more-users">
            <div class="current-user">
                <div class="other-user-details">
                    <div class="other-user-username">Rostislav Orlov</div>
                    <div class="other-user-email">r1@mail.ru</div>
                </div>
            </div>
            <div class="current-user">
                <div class="other-user-details">
    ...
    <div class="conference-users-window">
        ...
        <div v-for="user in notAdmins" :key="user.userId">
        ...
        <div v-for="user in usersWaitingHall" :key="user.userId">
                <div class="users-window-users-people-img"></div>
                <div class="users-window-users-people-fullname">{{ user.username }}</div>
                <div class="users-window-users-people-audio"></div>
                <div class="users-window-users-people-video"></div>
